package com.sda.lib.view.pulltorefreshlib;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (a.hasValue(R.styleable.PullToRefresh_mode_pull)) {
            mode = a.getInteger(R.styleable.PullToRefresh_mode_pull, MODE_PULL_DOWN_TO_REFRESH);
        }
        ...
        // Styleables from XML
        if (a.hasValue(R.styleable.PullToRefresh_headerTextColor_pull)) {
            final int color = a.getColor(R.styleable.PullToRefresh_headerTextColor_pull, Color.BLACK);
            if (null != headerLayout) {
